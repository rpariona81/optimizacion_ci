 ...
 * @author locador1dnce
 */
class Encuestaccf_model extends CI_Model {
    ...
    public function listcuest() {
        $query = $this->db->get('cuest_todos_ccf');
        return $query->result();
    }
    ...
    public function listcuestusuario($usuario) {
        ...
        $query = $this->db->get('cuest_usuario_ccf');
        return $query->result();
    }
    ...
    public function insertpag1($registro) {
        ...
        $this->db->update('t_ccf_pag1', $registro);
    }
    ...
    public function insertpag2($registro) {
        ...
        $this->db->set($registro);
        $this->db->where('ID', $registro['ID']);
        $this->db->update('t_ccf_pag2', $registro);
    }
    ...
    public function insertpag3($registro) {
        ...
        $this->db->set($registro);
        $this->db->where('ID', $registro['ID']);
        $this->db->update('t_ccf_pag3', $registro);
    }
    ...
    public function ultcuest($usuario) {
        ...
        return $this->db->get('carga_usuario_ccf')->row();
    }
    
    public function carga_usuario($usuario) {
        return $this->db->get('carga_usuario_ccf');
    }

    public function findpage1($id) {
        $this->db->where('ID', $id);
        return $this->db->get('t_ccf_pag1')->row();
    }

    public function findpage2($id) {
        $this->db->where('ID', $id);
        return $this->db->get('t_ccf_pag2')->row();
    }

    public function findpage3($id) {
        $this->db->where('ID', $id);
        return $this->db->get('t_ccf_pag3')->row();
    }
    ...
    public function delete($id) {
        ...
        $this->db->where('id', $id);
        $this->db->update('t_ccf_pag1', $activo);
        $this->db->update('t_ccf_pag2', $activo);
        $this->db->update('t_ccf_pag3', $activo);
    }
