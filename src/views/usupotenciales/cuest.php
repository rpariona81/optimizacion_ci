<script>
    $(document).ready(function () {
        ...
        $("form[name='page1']").validate({
            ...
            rules: {
                NOMBRES: {required: true, digits: false, minlength: 12},
                APELLIDOS: {required: true, digits: false, minlength: 12},
                DIRECCION: "required",
                P1: {
                    required: true,
                    digits: true,
                ...
                P5_O: {
                    required: {
                        depends: function () {
                            return $('input[name=P5]:checked').val() == '10';
                        }
                    }
                },
                P9: "required",
                ...
                P12_O: {
                    required: {
                        depends: function () {
                            return $('input[name=P12]:checked').val() == '5';
                        }
                    }
                },
                P13: "required",
                P13_O: {
                    required: {
                        depends: function () {
                            return $('input[name=P13]:checked').val() == '8';
                        }
                    }
                },
                P14: "required",
                ...
                P15_O: {
                    required: {
                        depends: function () {
                            return $('input[name=P15]:checked').val() == '5';
                        }
                    }
                },
                P16: "required",
                P17_1: {
                    required: {
                        depends: function () {
                            return $('input[name=P16]:checked').val() == '1';
                        }
                    }
                },
                P17_2: {
            ...
            messages: {
                NOMBRES: "Debe indicar sus nombres",
                APELLIDOS: "Debe indicar sus apellidos",
                DIRECCION: "Indicar domicilio actual",
                P1: "Falta esta informacion",
                P2: "Falta esta informacion",
                P3: "Falta esta informacion",
                P4: "Falta esta informacion",
                P5: "Falta esta informacion",
                P5_O: "Falta esta informacion",
                P9: "Falta esta informacion",
                P10_AUX: "Debe indicar al menos una opcion"
            },
...
<br/>
<ul class="tab">
    <li class="pull-left"><a href="<?= site_url('usupotenciales/index/'); ?>">Regresar a la lista</a></li>
</ul>
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <?= form_open('usupotenciales/registra_cuest', array('id' => 'page1', 'name' => 'page1', 'class' => 'form-horizontal')); ?>
        <?= validation_errors(); ?>
        <fieldset>
