        ...
        <fieldset>
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="col-sm-7">
                    ...
                    $dataP19_3 = array(
                        'name' => 'P19', 'id' => 'P19', 'value' => 3, 'checked' => ($form2->P19 == '3' ? TRUE : FALSE), 'style' => 'margin-right:5px');
                    ?>
                    <div class="col-sm-2">                        
                    ...
                    <div class="col-sm-3">
                        <?= form_label(form_radio($dataP19_3) . ' No sabe / No opina', 'P19_x3', array('class' => 'radio-inline')); ?>
                    </div>
                </div>
            </div>
